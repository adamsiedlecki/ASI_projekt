...
generation_name = st.text_input("Generacja (opcjonalnie)")
...
age_years = current_year - year if year < current_year else 1  # min 1 rok
mileage_per_year = mileage / age_years
